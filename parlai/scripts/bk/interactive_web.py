...
<html>
    ...
    <head><title> Alisa|English conversation practice with AI chat.</title>
    <script src="https://kit.fontawesome.com/126493fdb8.js" crossorigin="anonymous"></script>
    </head>
    <body>
    <div style="text-align: center">
    <p><img src="https://altavista21.com/img/alisa.png"></p>
    </div>
        <div class="columns" style="height: 80%">
            <div class="column is-three-fifths is-offset-one-fifth">
              <section class="hero is-info is-large has-background-alisa has-text-grey-dark" style="height: 100%">
                      ...
                      <div class="media-content">
                        <div class="content">
                          <p>
                            <strong>Alisa</strong>
                            <br>
                            Enter a message, and Alisa will respond interactively.
                          </p>
                        </div>
                      </div>
                    </article>
                ...
                <div class="hero-foot column is-three-fifths is-offset-one-fifth" style="height: 76px">
                  <form id = "interact">
                      <div class="field is-grouped">
                        ...
                        <p class="control">
                          <button id="respond" type="submit" class="button has-text-white-ter has-background-myblue">
                            Submit
                          </button>
                        </p>
                        <p class="control">
                          <button id="restart" type="reset" class="button has-text-white-ter has-background-myblue">
        ...
        <script>
            function createChatRow(agent, text) {{
                ...
                icon.className = "fas fas fa-2x" + (agent === "You" ? " fa-user my-skyblue" : agent === "Alisa" ? " fa-user-circle my-pink" : "");
            ...
            document.getElementById("interact").addEventListener("submit", function(event){{
                ...
                fetch('/interact', {{
                    ...
                    parDiv.append(createChatRow("Alisa", data.text));
            ...
            document.getElementById("interact").addEventListener("reset", function(event){{
                ...
                fetch('/reset', {{
                    ...
                    parDiv.innerHTML = '';
                    parDiv.append(createChatRow("Instructions", "Enter a message, and Alisa will respond interactively."));
                    parDiv.scrollTo(0, parDiv.scrollHeight);
                }})
            }});
        </script>
